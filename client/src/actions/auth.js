...
export const registerUser = (email, password, name, passwordConfirmation, history) => {
  return dispatch => {
    axios.post('/api/auth', { email, name, password, password_confirmation: passwordConfirmation })
      .then(res => {
